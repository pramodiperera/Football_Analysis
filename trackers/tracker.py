...
class Tracker:
    ...
    def get_object_trackers(self, frames, read_from_stub = False, stub_path = None):
        ...
        for frame_num, detection in enumerate(detections):
            ...
            cls_names_inv = {v:k for k, v in cls_names.items()}  # player:3, goalkeeper:2 etc.
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
        ...
        cv2.putText(frame, f"Ball Control by team 1: {team_1*100:.2f}%",(1400,900), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,0), 3)
        cv2.putText(frame, f"Ball Control by team 2: {team_2*100:.2f}%",(1400,950), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,0), 3)
    ...
    def draw_annotation(self, video_frames, tracks, team_ball_control): 
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            for track_id, player in player_dict.items():
                color = player.get("team_color", (0, 0, 255)) # get the color from the model
